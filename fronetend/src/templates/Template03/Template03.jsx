...
const Template03 = ({ data }) => {
    return (
        <div className="template3 border rounded-3 shadow-lg mx-auto my-5 p-4 bg-white" style={{maxWidth: '950px'}}>
            {/* Header Section - vertical, left-aligned */}
            <div className="row mb-4">
                <div className="col-12 d-flex flex-column align-items-start">
                    {data.companyLogo && (
                        <img src={data.companyLogo} alt="Company Logo" className="img-fluid mb-2" style={{ maxWidth: '120px', maxHeight: '80px', objectFit: 'contain' }} />
                    )}
            ...
            <div className="row mb-4">
                <div className="col-12 text-end">
                    <h1 className="invoice-title mb-2 text-primary">INVOICE</h1>
                    <div className="d-inline-block bg-light rounded px-3 py-2 shadow-sm">
            ...
            {/* Billing & Shipping Section - stacked cards */}
            <div className="row g-3 mb-4">
                {data.shippingName && data.shippingAddress && data.shippingPhone && (
                    <div className="col-md-6">
                        <div className="p-3 rounded-2 bg-light shadow-sm h-100">
                            <h5 className="mb-2 text-secondary">Shipping To</h5>
                ...
                <div className="col-md-6">
                    <div className="p-3 rounded-2 bg-light shadow-sm h-100">
                        <h5 className="mb-2 text-secondary">Billing To</h5>
            ...
            <div className="mb-4">
                <div className="d-flex justify-content-end">
                    <div className="p-3 bg-light rounded-2 shadow-sm" style={{maxWidth: '350px'}}>
                        ...
                        <div className="d-flex justify-content-between fw-bold pt-2">
                            ...
                            <span className="fs-5 text-primary">${data.total.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {(data.accountName || data.accountNumber || data.accountIfsccoed) && (
                <div className="mt-4 pt-3 border-top">
                    <h5 className="mb-3 text-secondary">Bank Account Details</h5>
                    <div className="row">
                        {data.accountName && (
            ...
            {data.notes && (
                <div className="mt-4 pt-3 border-top">
                    <h5 className="mb-3 text-secondary">Additional Notes</h5>
